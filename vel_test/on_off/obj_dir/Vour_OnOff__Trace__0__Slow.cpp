...
VL_ATTR_COLD void Vour_OnOff___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vour_OnOff___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vour_OnOff___024root__trace_full_sub_0(Vour_OnOff___024root* vlSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vour_OnOff___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    ...
    Vour_OnOff__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vour_OnOff___024root__trace_full_sub_0((&vlSymsp->TOP), bufp);
}
